...
def build_delete_announce(score: int, timer: float) -> str:
    ...
    encoded_time = iso_time.replace(":", "%3A")
    return f"""此文章目前为{score}分，现依据[[[deletions-guide|删除指导]]]宣告将删除此页面：

[[iframe https://timerdfc.pages.dev/timer.html?lang=zh-hans&time={encoded_time}&progress=%E6%AD%A4%E9%A1%B5%E9%9D%A2%E5%B0%86%E5%9C%A8%E4%BB%A5%E4%B8%8B%E6%97%B6%E9%97%B4%E5%90%8E%E5%88%A0%E9%99%A4%EF%BC%9A&finished=%E6%AD%A4%E9%A1%B5%E9%9D%A2%E5%9C%A8%E4%BB%A5%E4%B8%8B%E6%97%B6%E9%97%B4%E5%89%8D%E5%8F%AF%E5%88%A0%E9%99%A4%EF%BC%9A style="width: 100%; height: 165px; border: 0; text-align: center;"]]
